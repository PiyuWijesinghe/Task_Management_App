    ...
    <div class="flex h-screen bg-transparent">
        ...
        <div class="flex-1 overflow-auto bg-transparent">
            <div class="p-6">
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl overflow-hidden shadow-2xl rounded-2xl border border-white/20 dark:border-gray-700/20 mb-6">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
                                <span>{{ $pending->count() + $inProgress->count() + $completed->count() }} tasks</span>
                            </div>
                        </div>
                        ...
                        <form method="GET" action="{{ route('tasks.index') }}" class="flex flex-wrap items-center gap-4">
                            ...
                            @if(request('status'))
                                <div class="flex items-center space-x-2 text-sm">
                                    <span class="text-gray-600 dark:text-gray-400">Filtered by status:</span>
                                    <span class="px-2 py-1 bg-purple-100 dark:bg-purple-800 text-purple-700 dark:text-purple-300 rounded-full text-xs font-medium">
                                        {{ request('status') }}
                                    </span>
                                </div>
                            @endif
